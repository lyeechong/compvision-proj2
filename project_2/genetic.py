...
def test_weights(left, right):
    ...
    for x in range(0, num_threads):
        ...
        results[weights] = pool.apply_async(evaluate_weights,
                                            (left, right, weights,))
    ...
    # list of weights, median
    return sorted_swag[0], swag[sorted_swag[0]]
...
if __name__ == '__main__':
    ...
    disparity_expected = cv2.imread('disparity_test_data/' + directory +
                                    '/disp1.png',
